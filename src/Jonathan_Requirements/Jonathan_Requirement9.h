...
#ifndef _Requirement9_h_
#define _Requirement9_h_
...
/// Ref: R9 Req. 9 holds parameters for block definitions
/// Declaration copied from item.h line 63
extern const int blocks[256][6];

/**@}*/
#endif /* Reqquirement9_h_ */